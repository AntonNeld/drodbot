...
class DrodBot:
    ...
    async def initialize(self):
        ...
        self._state.room = visual_info["room"]
    ...
    async def go_to(self, element):
        ...
        """
        player_position = self._state.room.find_player()
        goal_positions = self._state.room.find_coordinates(element)
        actions = find_path(player_position, goal_positions, self._state.room)
